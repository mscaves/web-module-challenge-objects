...
console.log(createMenuItem("fries", 1, "Misc"));
console.log(createMenuItem("sushi", 15, "Dinner"));
console.log(createMenuItem("beer", 7, "Drink"));
...
function getLastReview(array) {
  let lastn = array.length - 1;
  return`${array[lastn].name} gave the restaurant a ${array[lastn].rating} star review, and their feedback was: ${array[lastn].feedback}`;
} 
